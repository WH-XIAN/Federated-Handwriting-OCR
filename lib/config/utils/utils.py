...
def create_log_folder(cfg, phase='train'):
    ...
    log_file = root_output_dir / dataset / model / time_str / 'train.log'
    ...
    return {'chs_dir': str(checkpoints_output_dir), 'tb_dir': str(tensorboard_log_dir),'log_file': str(log_file)}
